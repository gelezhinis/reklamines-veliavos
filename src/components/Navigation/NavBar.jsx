    ...
    <div className={classes.nav}>
      <div className={classes.nav_wrap}>
        ...
        <ul className={classes.nav_list}>
          ...
          <li>
            <NavLink to="/gallery" activeClassName={classes.active}>Galerija</NavLink>
          </li>
          <li>
            <NavLink to="/contact" activeClassName={classes.active}>Kontaktai</NavLink>
          </li>
          <li>
            <NavLink to="/order" activeClassName={classes.active}>Užsakyti</NavLink>
          </li>
        </ul>
