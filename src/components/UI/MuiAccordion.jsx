...
const MuiAccordion = () => {
  ...
  return (
    ...
    <Card>
      <div className={classes.title}>
        <h3>Taip pat galėsite pasirinkti Jums tinkamiausią vėliavos pagrindą ir kitus priedus</h3>
      </div>
      <div className={classes.foundation}>
        <img src={found} alt="foundation" ref={ref5} className={`${classes.img_card} ${
